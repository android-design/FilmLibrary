...
@Component(
    modules = [AndroidSupportInjectionModule::class, DatabaseModule::class, RemoteModule::class,
        ...
        TopFragmentsModule::class, UpcomingMoviesModule::class,
        ...
        VideosModule::class, FullFilmInfoFragmentModule::class, MovieCreditsModule::class, MovieImagesModule::class, SimilarMoviesModule::class]
)
